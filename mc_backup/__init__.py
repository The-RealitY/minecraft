...
def parse_auth_roles(env_value):
    """Parse a comma-separated string of role IDs into a list of ints, ignoring empty/invalid entries."""
...
DISCORD_AUTH_ROLES = parse_auth_roles(os.getenv('DISCORD_AUTH_ROLES', "0"))
